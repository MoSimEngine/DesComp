...
public class ImportWorkwaySim {
	...
	private void importWorkwaySimViaSoot() {

		String[] args1 = { "-w", "-process-dir",
				"/home/johannes/studium/masterarbeit/gitTest/masterarbeit/lib/workwaySim.jar" };
...
//Options.v().setPhaseOption("cg.spark", "on");
		...
		Simulator importBussim = new Simulator("IMPORT_WORKWAYSIM", "Tolle WORKWAYSIM");
